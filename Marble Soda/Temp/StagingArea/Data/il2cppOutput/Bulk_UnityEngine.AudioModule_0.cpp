...
{
	typedef float (*AudioListener_get_volume_m3225661647_ftn) ();
	static AudioListener_get_volume_m3225661647_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (AudioListener_get_volume_m3225661647_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.AudioListener::get_volume()");
	float retVal = _il2cpp_icall_func();
	return retVal;
}
// System.Void UnityEngine.AudioListener::set_volume(System.Single)
extern "C" IL2CPP_METHOD_ATTR void AudioListener_set_volume_m1228243532 (RuntimeObject * __this /* static, unused */, float ___value0, const RuntimeMethod* method)
{
	typedef void (*AudioListener_set_volume_m1228243532_ftn) (float);
	static AudioListener_set_volume_m1228243532_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (AudioListener_set_volume_m1228243532_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.AudioListener::set_volume(System.Single)");
